...
1. Have you explored things outside of the steps in the tutorial, for example: src/lib.rs? If not, explain why you did not do so. If yes, explain things that you have learned from those other parts of code.
    - Saya lebih fokus pada implementasi fungsionalitas di layer Repository dan Service sesuai langkah tutorial untuk memastikan alur Pub-Sub berjalan lancar terlebih dahulu sebelum mendalami modul library-nya.
2. Since you have completed the tutorial by now and have tried to test your notification system by spawning multiple instances of Receiver, explain how Observer pattern eases you to plug in more subscribers. How about spawning more than one instance of Main app, will it still be easy enough to add to the system?
    - Observer Pattern sangat memudahkan penambahan subscriber baru (Receiver). Kita cukup menjalankan instance baru pada port yang berbeda (misal 8002, 8003) dan memanggil endpoint /subscribe. Publisher (Main App) tidak perlu diubah kodenya sama sekali untuk mengenali subscriber baru; ia hanya perlu menyimpan daftar URL subscriber yang aktif. 
    - Bagaimana jika Main App (Publisher) ada lebih dari satu?
      - Jika kita menjalankan lebih dari satu instance Main App, tantangannya adalah sinkronisasi data. Secara default, daftar subscriber biasanya disimpan di memori, jika ada dua Main App, subscriber yang mendaftar di Main App A tidak akan diketahui oleh Main App B. Agar tetap mudah, kita perlu menggunakan database eksternal atau message broker (seperti Redis atau RabbitMQ) sebagai pusat data subscriber agar semua instance Main App merujuk pada daftar yang sama.
3. Have you tried to make your own Tests, or enhance documentation on your Postman collection? If you have tried those features, tell us whether it is useful for your work (it can be your tutorial work or your Group Project).
    - Saya mencoba menambahkan test case manual/memperbarui koleksi Postman untuk memastikan fungsionalitas /receive dan /list berjalan dengan benar. Fitur ini sangat berguna, terutama untuk memastikan pesan benar-benar sampai ke Receiver tanpa harus mengecek log terminal satu per satu dan membantu saat integrasi antara backend dan frontend. Dengan dokumentasi Postman yang jelas, rekan tim saya yang mengerjakan bagian lain bisa langsung tahu format JSON apa yang dikirim tanpa harus membaca baris kode Rust saya.
